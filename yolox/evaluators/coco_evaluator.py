...
class COCOEvaluator:
    ...
    def evaluate_prediction(self, data_dict, statistics):
        ...
        if len(data_dict) > 0:
            ...
            if self.testdev:
                ...
                json.dump(data_dict, open("/home/megstudio/workspace/submit/results_x.json", "w"))
                print("测试结果已经保存在/home/megstudio/workspace/submit/下")
    ...
    def coco_load_test(self):
        cocoGt = self.dataloader.dataset.coco
        cocoDt = cocoGt.loadRes("/home/megstudio/workspace/submit/results_x.json")
        print("可以加载")
        print(cocoDt)
        
if __name__ == '__main__':
    coco = COCO("/home/megstudio/workspace/submit/resultstttt.json")
    print(coco)
